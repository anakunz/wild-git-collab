...
ggplot(data = diamonds, aes(x = carat, y = cut, color = price)) +
  geom_point() +
  theme_minimal()+
  labs(
    x = "carat!!!"
  )
# a SUPER exciting graph :) definitely!
```

```{r break-it-2}
# Yay branches! Woooohooo
